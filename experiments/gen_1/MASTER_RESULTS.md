...
All plots are located in the workspace under `experiments/gen_1/`. Below is a catalog with descriptions.
...
*Source: V1–V4 documentation, CSV results, benchmark data, and analysis notebooks in `experiments/gen_1/`*

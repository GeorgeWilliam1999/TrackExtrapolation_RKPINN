...
**Trained Models:** 23 total (8 MLP width sweep, 8 QuadraticResidual, 7 PINNZFracInput)
...
**Setup:** Use the `PINNWithZFracInput` variant already defined in [pinn_residual.py](../V3/models/pinn_residual.py). This feeds z_frac as a 7th input to the core network, allowing the network to learn *nonlinear* z_frac dependence.
...
V4/
├── README.md                          # This file
├── PINN_ARCHITECTURE_DIAGNOSIS.md     # Complete technical analysis (11,000 words)
├── DOCUMENTATION_INDEX.md             # Navigation guide and document roadmap
├── README_DOCUMENTATION.md            # Documentation summary and statistics
├── train_pinn_v4.ipynb                # PINN training notebook
├── p1_zfrac_linearity.png             # z_frac linearity analysis plot
├── pinn_training_curves.png           # PINN training curves plot
├── pinn_trajectory_comparison.png     # PINN trajectory comparison plot
├── training/                          # Training scripts
│   ├── train_v4.py                    # V4 training script
│   ├── train_v4_wrapper.sh            # Condor wrapper
│   └── configs/                       # Training configurations
├── cluster/                           # Condor submission scripts
│   ├── submit_all_v4.sh               # Submit all V4 jobs
│   ├── submit_v4_training.sub         # Condor submission file
│   └── v4_jobs.txt                    # Job list
├── analysis/                          # Results analysis
│   ├── collect_results.py             # Collect results across models
│   └── cross_version_results.csv      # Cross-version comparison data
└── trained_models/                    # 23 trained model checkpoints
    ├── mlp_v4_1L_{512,1024,2048,4096}/        # 4 single-layer MLPs
    ├── mlp_v4_2L_{512_256,...,4096_2048}/      # 4 two-layer MLPs
    ├── quad_v4_1L_{512,1024,2048,4096}/       # 4 single-layer QuadraticResidual
    ├── quad_v4_2L_{512_256,...,4096_2048}/     # 4 two-layer QuadraticResidual
    ├── zfrac_v4_1L_{512,1024,2048}/           # 3 single-layer PINNZFracInput
    └── zfrac_v4_2L_1024_512/                  # 1 two-layer PINNZFracInput
```

...
V2/
├── README.md                      # This file
├── PINN_ARCHITECTURE_ISSUE.md     # PINN architecture issue analysis
...
│   ├── submit_v2_limited.sub
│   ├── submit_v2_retry.sub
│   └── v2_jobs.txt
├── analysis/                      # Analysis results
│   ├── README.md
│   ├── v2_model_analysis.ipynb    # V2 model analysis notebook
│   ├── analyze_v2_results.py      # Results analysis
│   ├── generate_paper_quality_plots.py  # Publication plots
│   └── timing_comparison_plots.py # Timing comparisons
├── results/                       # Experiment results
│   ├── README.md
│   ├── v2_model_results.csv
│   └── v2_pareto_models.csv

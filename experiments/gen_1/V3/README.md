...
**Status:** ✅ Training Complete (8 models trained)  
...
V3/
├── README.md                          # This file
├── PINN_EXPLAINED.md                  # PINN architecture explanation
├── PLAN.md                            # V3 experiment plan
├── regenerate_all.sh                  # Regenerate all data/models
├── data_generation/
│   ├── generate_variable_dz.py        # Main variable dz data generator
│   ├── generate_trajectories.py       # Full trajectory generator
│   ├── extract_segments.py            # Extract (state, dz) segments
│   ├── merge_samples.py               # Merge distributed samples
│   └── merge_trajectories.py          # Merge distributed trajectories
├── models/
│   ├── architectures.py               # MLP architecture definitions
│   └── pinn_residual.py               # PINN residual architecture
├── training/
│   ├── train_mlp.py                   # MLP training script
│   ├── train_pinn.py                  # PINN training script
│   ├── train_v3_wrapper.sh            # Condor wrapper
│   ├── README.md
│   └── configs/                       # 12 training configurations
│       ├── mlp_v3_{shallow_256,shallow_512,deep_128,deep_256}.json
│       ├── pinn_v3_{shallow_256,deep_128}.json
│       ├── pinn_v3_res_256_col{5,10,20,50}.json
│       └── rkpinn_v3_{shallow_256,deep_128}.json
├── cluster/                           # ~35 Condor submission scripts
│   ├── submit_v3_training.sub
│   ├── submit_all_training*.sub/.sh
│   ├── submit_{mlp,pinn}_*.sub         # Per-model submissions
│   ├── v3_jobs.txt
│   └── v3_pipeline.dag                # DAGMan pipeline
├── deployment/
│   └── export_to_cpp.py               # Export model to C++ binary
├── analysis/
│   ├── benchmark_v3_models.ipynb      # V3 model benchmarking notebook
│   ├── visualize_pinn.ipynb           # PINN visualization notebook
│   ├── benchmark_cpp.cpp              # C++ benchmark source
│   ├── benchmark_results_v3.csv       # Benchmark results
│   └── *.png                          # Generated plots (5 files)
├── trained_models/                    # 8 trained model checkpoints
│   ├── mlp_v3_{deep_128,deep_256,shallow_256,shallow_512}/
│   └── pinn_v3_res_256_col{5,10,20,50}/
└── utils/
